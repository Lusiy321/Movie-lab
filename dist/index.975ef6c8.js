...
},{}],"8Jsh2":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "onSearch", ()=>onSearch);
var _renderMain = require("../render-main");
...
async function onSearch(e) {
    ...
    if (!query) {
        (0, _consts.error).textContent = "Search result not successful. Enter the correct movie name and try again";
        return;
    } else try {
        await (0, _mainPageMovie.fetchQuery)(query, (0, _consts.page)).then((res)=>{
            ...
            (0, _consts.pagin).reset(result);
            (0, _consts.container).innerHTML = null;
            (0, _renderMain.renderMain)(res.data);
        });
        (0, _consts.pagin).on("afterMove", async ({ page  })=>{
            await (0, _mainPageMovie.fetchQuery)(query, page).then((res)=>{
...
},{"./consts":"g20t7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./main-page-movie":"b0Faj","../render-main":"5wp9N"}],"g20t7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
parcelHelpers.export(exports, "pagin", ()=>pagin);
...
const pagin = (0, _pagination.pagination)();
let page = pagin.getCurrentPage();
const container = document.querySelector(".gallery");
const form = document.querySelector(".search-form");
const error = document.querySelector(".error-js");

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../pagination":"9j1Dd"}],"9j1Dd":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const containerPag = document.getElementById("pagination");
function pagination(params = {}) {
    ...
    return new (0, _tuiPaginationDefault.default)(containerPag, {
        ...options,
        ...params
    });
}
...
},{}],"b0Faj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
async function popularMovie(page) {
    try {
        const resp = await (0, _axiosDefault.default).get(`${(0, _consts.URL)}${(0, _consts.POPULAR)}&page=${page}&api_key=${(0, _consts.KEY)}`);
        return resp;
    } catch (e) {
        return Error;
    }
...
},{"axios":"jo6P5","./consts":"g20t7","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5wp9N":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "mainPage", ()=>mainPage);
parcelHelpers.export(exports, "renderMain", ()=>renderMain);
...
async function mainPage() {
    try {
        ...
        (0, _consts.pagin).on("afterMove", async ({ page  })=>{
            await (0, _mainPageMovie.popularMovie)(page).then((resp)=>{
                renderMain(resp.data);
            });
        });
    } catch (e) {
